...
class CountryMapperTest {
    ...
    private static Stream<Arguments> providerEntities() {
        return Stream.of(
                Arguments.of(new Country(Long.MIN_VALUE, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3, List.of())),
                Arguments.of(new Country(-1L, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3, List.of())),
                Arguments.of(new Country(0L, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3, List.of())),
                Arguments.of(new Country(1L, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3, List.of())),
                Arguments.of(new Country(Long.MAX_VALUE, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3, List.of())),
                Arguments.of(new Country(Long.MAX_VALUE, null, COUNTRY_TEST_ISO_3166_ALPHA_3, List.of())),
                Arguments.of(new Country(Long.MAX_VALUE, COUNTRY_TEST_NAME, null, List.of())),
    ...
    private static Stream<Arguments> providerDto() {
        return Stream.of(
                Arguments.of(new CountryDto(Long.MIN_VALUE, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3)),
                Arguments.of(new CountryDto(-1L, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3)),
                Arguments.of(new CountryDto(0L, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3)),
                Arguments.of(new CountryDto(1L, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3)),
                Arguments.of(new CountryDto(Long.MAX_VALUE, COUNTRY_TEST_NAME, COUNTRY_TEST_ISO_3166_ALPHA_3)),
                Arguments.of(new CountryDto(Long.MAX_VALUE, null, COUNTRY_TEST_ISO_3166_ALPHA_3)),
                Arguments.of(new CountryDto(Long.MAX_VALUE, COUNTRY_TEST_NAME, null)),
